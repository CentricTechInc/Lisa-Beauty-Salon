...
class CustomerFaqPage extends StatefulWidget {
  const CustomerFaqPage({super.key});

  @override
  State<CustomerFaqPage> createState() => _CustomerFaqPageState();
}

class _CustomerFaqPageState extends State<CustomerFaqPage> {
